function Dashboard(config) {
  const i18n = {
    ...
    sceneTriggerText:
      /*[[#{index.scene.trigger.text}]]*/ 'Are you sure you want to activate the "{0}" scene?',
    ...
    sceneTriggerSuccessText:
      /*[[#{index.scene.trigger.success_text}]]*/ 'Scene "{0}" has been activated.',
  };
					...
					<div class="row g-0 text-center">
						...
						<div class="col-4">
							<div class="d-flex flex-column align-items-center">
								...
								<span class="stat-value">${info && info.latestSumWatt ? info.latestSumWatt.toFixed(1) + 'W' : '--'}</span>
