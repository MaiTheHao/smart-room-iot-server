...
!(function (e, n) {
  ...
  function k(p, v) {
    ...
    function re() {
      !w.isOpen || w.config.system || w.config.inline || de();
    }
    function le(e) {
      return function (n) {
      ...
      if ('function' != typeof w.config.position) {
        if (void 0 !== w.calendarContainer) {
          ...
          if ((s(w.calendarContainer, 'arrowTop', !d), s(w.calendarContainer, 'arrowBottom', d), !w.config.inline)) {
            ...
            if ((s(w.calendarContainer, 'rightMost', h), !w.config.system))
    ...
    ((w.parseDate = C({ config: w.config, l10n: w.l10n })),
      ...
      (w.destroy = function () {
        ...
        if (((w._handlers = []), w.mobileInput)) (w.mobileInput.parentNode && w.mobileInput.parentNode.removeChild(w.mobileInput), (w.mobileInput = void 0));
          ...
          if (w.config.system && w.calendarContainer.parentNode) {
        ...
        ((w.element = w.input = p),
          ...
          (function () {
            ...
            ((w.input._type = w.input.type),
              ...
              w.config.altInput &&
                ...
                !w.config.system && w.input.parentNode && w.input.parentNode.insertBefore(w.altInput, w.input.nextSibling)));
          ...
          w.isMobile ||
            (function () {
              ...
              if (
                (w.config.inline || w.config.system) &&
              ...
              w.config.system || w.config.inline || (void 0 !== w.config.appendTo ? w.config.appendTo : window.document.body).appendChild(w.calendarContainer);
            })(),
          (function () {
            w.config.wrap &&
            ...
            w.config.inline || w.config.system || P(window, 'resize', e);
