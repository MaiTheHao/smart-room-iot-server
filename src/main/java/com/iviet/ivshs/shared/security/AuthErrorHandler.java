...
public class AuthErrorHandler {
    ...
    public enum ErrorType {
        RECURSIVE_CALL("recursive_call"), TOKEN_EXPIRED("token_expired"), INVALID_SIGNATURE("invalid_signature"), MALFORMED_TOKEN("malformed_token"), INVALID_CREDENTIALS("invalid_credentials"), USER_NOT_FOUND("user_not_found"), INSUFFICIENT_AUTH(
                "insufficient_auth"), UNKNOWN("unknown");
