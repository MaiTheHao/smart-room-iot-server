...
import com.iviet.ivshs.shared.exception.domain.RemoteResourceNotFoundException;
...
public class HttpClientUtil {
	...
	public static class Response<T> {
		...
		private Response(int statusCode, String rawBody, Map<String, String> headers, Class<T> responseType,
	 ...
	 * 
	 * @param url          Request URL
	 * @param responseType Target class for deserialization (e.g.,
	...
	// ===== POST =====
	/**
	 * Send POST request with object body (auto-serialized) and return raw String
	 * response.
	 * 
	 * @param url     Request URL
	...
	/**
	 * Send POST request with object body and deserialize response to specified
	 * type.
	 * 
	 * @param url          Request URL
	 * @param bodyObj      Object to serialize as JSON body
	...
	// ===== PUT =====
	/**
	 * Send PUT request with object body (auto-serialized) and return raw String
	 * response.
	 * 
	 * @param url     Request URL
	 * @param bodyObj Object to serialize as JSON body
	...
	// ===== PATCH =====
	/**
	 * Send PATCH request with object body (auto-serialized) and return raw String
	 * response.
	 * 
	 * @param url     Request URL
	 * @param bodyObj Object to serialize as JSON body
	...
	/**
	 * Send PATCH request with object body and deserialize response to specified
	 * type.
	 * 
	 * @param url          Request URL
	 * @param bodyObj      Object to serialize as JSON body
	...
	/**
	 * Send async GET request using custom Request builder with type
	 * deserialization.
	 * 
	 * @param request      Custom request configuration
	 * @param responseType Target class for deserialization
	...
	// ===== ASYNC POST =====
	/**
	 * Send async POST request with object body (auto-serialized) and return raw
	 * String response.
	 * 
	 * @param url     Request URL
	 * @param bodyObj Object to serialize as JSON body
	...
	/**
	 * Send async POST request with object body and deserialize response to
	 * specified type.
	 * 
	 * @param url          Request URL
	 * @param bodyObj      Object to serialize as JSON body
	 ...
	 * @return CompletableFuture<Response<T>>
	 */
	public static <T> CompletableFuture<Response<T>> postAsync(String url, Object bodyObj,
			TypeReference<T> typeReference) {
	...
	/**
	 * Send async POST request using custom Request builder with type
	 * deserialization.
	 * 
	 * @param request      Custom request configuration
	 * @param responseType Target class for deserialization
	...
	// ===== ASYNC PUT =====
	/**
	 * Send async PUT request with object body (auto-serialized) and return raw
	 * String response.
	 * 
	 * @param url     Request URL
	 * @param bodyObj Object to serialize as JSON body
	...
	/**
	 * Send async PUT request with object body and deserialize response to specified
	 * type.
	 * 
	 * @param url          Request URL
	 * @param bodyObj      Object to serialize as JSON body
	 ...
	 * @return CompletableFuture<Response<T>>
	 */
	public static <T> CompletableFuture<Response<T>> putAsync(String url, Object bodyObj,
			TypeReference<T> typeReference) {
	...
	/**
	 * Send async PUT request using custom Request builder with type
	 * deserialization.
	 * 
	 * @param request      Custom request configuration
	 * @param responseType Target class for deserialization
	...
	// ===== ASYNC PATCH =====
	/**
	 * Send async PATCH request with object body (auto-serialized) and return raw
	 * String response.
	 * 
	 * @param url     Request URL
	 * @param bodyObj Object to serialize as JSON body
	...
	/**
	 * Send async PATCH request with object body and deserialize response to
	 * specified type.
	 * 
	 * @param url          Request URL
	 * @param bodyObj      Object to serialize as JSON body
	 ...
	 * @return CompletableFuture<Response<T>>
	 */
	public static <T> CompletableFuture<Response<T>> patchAsync(String url, Object bodyObj,
			TypeReference<T> typeReference) {
	...
	/**
	 * Send async PATCH request using custom Request builder with type
	 * deserialization.
	 * 
	 * @param request      Custom request configuration
	 * @param responseType Target class for deserialization
	...
	/**
	 * Send async DELETE request using custom Request builder with type
	 * deserialization.
	 * 
	 * @param request      Custom request configuration
	 * @param responseType Target class for deserialization
	...
	private static <T> Response<T> execute(String method, Request request, Class<T> responseType,
		...
		try {
			...
			log.info("Executing HTTP {} on thread: name={}, isVirtual={}", method, Thread.currentThread().getName(),
	 ...
	 */
	private static <T> CompletableFuture<Response<T>> executeAsync(String method, Request request,
	...
	private static <T> Response<T> mapResponse(HttpResponse<String> response, Class<T> responseType,
			TypeReference<T> typeReference) {
