...
public class LightServiceImpl implements LightService {
  ...
  public PaginatedResponse<LightDto> getList(int page, int size) {
    ...
    return new PaginatedResponse<>(lightDao.findAll(page, size, langCode), page, size, lightDao.count());
  }
  ...
  public PaginatedResponse<LightDto> getListByRoomId(Long roomId, int page, int size) {
    ...
    var langCode = LocalContextUtil.getCurrentLangCode();
    return new PaginatedResponse<>(lightDao.findAllByRoomId(roomId, page, size, langCode), page, size, lightDao.countByRoomId(roomId));
  }
  ...
  public LightDto update(Long lightId, UpdateLightDto dto) {
    ...
    if (dto.isActive() != null)
      light.setIsActive(dto.isActive());
    if (dto.power() != null)
      light.setPower(dto.power());
    if (dto.level() != null)
