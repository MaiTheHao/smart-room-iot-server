...
public class AutomationServiceImpl extends AbstractSchedulableJobService<Automation> implements AutomationService {
	...
	public AutomationDto create(CreateAutomationDto dto) {
		...
		jobScheduleService.sync(automation);
	...
	public void delete(Long automationId) {
		...
		var automation = automationDao.findById(automationId)
				.orElseThrow(() -> new NotFoundException("Automation not found: " + automationId));
		jobScheduleService.delete(automation);
