...
public record GatewayCommand(
    ...
    // --- Compact factory methods (backward-compatible, metadata = empty) ---

    public static GatewayCommand of(String naturalId, DeviceCategory category,
                                     DeviceSpecificType specificType, String param, Object value) {
        return new GatewayCommand(naturalId, category, specificType, null,
            mapOf(param, value), Map.of());
    }

    public static GatewayCommand of(String naturalId, DeviceCategory category,
                                     DeviceSpecificType specificType, Integer duration,
                                     String param, Object value) {
        return new GatewayCommand(naturalId, category, specificType, duration,
            mapOf(param, value), Map.of());
    }
    ...
    public static class Builder {
        ...
        public Builder specificType(DeviceSpecificType t) { this.specificType = t; return this; }
        public Builder duration(Integer d) { this.duration = d; return this; }
