...
public class LanguageController {
  ...
  @GetMapping
  public ResponseEntity<ApiResponse<PaginatedResponse<LanguageDto>>> getLanguages(@RequestParam(name = "page", defaultValue = "0")
  ...
  @GetMapping("/{id}")
  public ResponseEntity<ApiResponse<LanguageDto>> getLanguageById(@PathVariable(name = "id")
  Long id) {
  ...
  public ResponseEntity<ApiResponse<LanguageDto>> getLanguageByCode(@PathVariable(name = "code")
  String code) {
  ...
  @PostMapping
  public ResponseEntity<ApiResponse<LanguageDto>> createLanguage(@RequestBody
  @Valid
  CreateLanguageDto request) {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<ApiResponse<LanguageDto>> updateLanguage(@PathVariable(name = "id")
  Long id, @RequestBody
  @Valid
  UpdateLanguageDto request) {

    return ResponseEntity.ok(ApiResponse.ok(languageService.update(id, request)));
  }

  @DeleteMapping("/{id}")
  public ResponseEntity<ApiResponse<Void>> deleteLanguage(@PathVariable(name = "id")
  Long id) {
