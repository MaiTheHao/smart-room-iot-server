...
public class TemperatureController {
  ...
  public ResponseEntity<ApiResponse<PaginatedResponse<TemperatureDto>>> getList(@RequestParam(name = "page", defaultValue = "0")
  ...
  public ResponseEntity<ApiResponse<PaginatedResponse<TemperatureDto>>> getListByRoomId(@PathVariable(name = "roomId")
  ...
  public ResponseEntity<ApiResponse<java.util.List<TemperatureDto>>> getAllByRoomId(@PathVariable(name = "roomId")
  Long roomId) {
  ...
  public ResponseEntity<ApiResponse<TemperatureDto>> getById(@PathVariable(name = "id")
  Long id) {
  ...
  public ResponseEntity<ApiResponse<TemperatureDto>> create(@RequestBody
  @Valid
  CreateTemperatureDto dto) {
  ...
  public ResponseEntity<ApiResponse<TemperatureDto>> update(@PathVariable(name = "id")
  Long id, @RequestBody
  @Valid
