...
public class PowerConsumptionController {
  ...
  public ResponseEntity<ApiResponse<PaginatedResponse<PowerConsumptionDto>>> getList(@RequestParam(name = "page", defaultValue = "0")
  ...
  public ResponseEntity<ApiResponse<PaginatedResponse<PowerConsumptionDto>>> getListByRoomId(@PathVariable(name = "roomId")
  ...
  public ResponseEntity<ApiResponse<java.util.List<PowerConsumptionDto>>> getAllByRoomId(@PathVariable(name = "roomId")
  Long roomId) {
  ...
  public ResponseEntity<ApiResponse<PowerConsumptionDto>> getById(@PathVariable(name = "id")
  Long id) {
  ...
  public ResponseEntity<ApiResponse<PowerConsumptionDto>> create(@RequestBody
  @Valid
  CreatePowerConsumptionDto dto) {
  ...
  public ResponseEntity<ApiResponse<PowerConsumptionDto>> update(@PathVariable(name = "id")
  Long id, @RequestBody
  @Valid
