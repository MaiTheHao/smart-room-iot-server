...
public class HardwareConfigController {
  ...
  public ResponseEntity<ApiResponse<PaginatedResponse<DeviceControlDto>>> getListByClient(
  ...
  public ResponseEntity<ApiResponse<PaginatedResponse<DeviceControlDto>>> getListByRoom(
