...
public record CreateFanIrDto(
        ...
        @NotNull(message = "Mode is required for IR fan") ActuatorMode mode,

        @NotNull(message = "Speed is required for IR fan") @Min(value = 1, message = "Speed must be at least 1") @Max(value = 3, message = "Speed must be at most 3") Integer speed,

        @NotNull(message = "Swing is required for IR fan") ActuatorSwing swing,

        @NotNull(message = "Light is required for IR fan") ActuatorPower light) implements CreateFanDto {
