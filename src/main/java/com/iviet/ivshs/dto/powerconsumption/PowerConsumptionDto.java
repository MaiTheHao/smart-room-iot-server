package com.iviet.ivshs.dto.powerconsumption;
...
public record PowerConsumptionDto(
    ...
    public PowerConsumptionDto(Long id, String name, String description, Boolean isActive, Double currentWatt,
            String naturalId, Long roomId, Long deviceControlId) {
        this(id, name, description, isActive, currentWatt, naturalId, roomId, deviceControlId,
