...
public class SysFunctionDao extends BaseTranslatableEntityDao<SysFunction> {
  ...
  private static final String DTO_CLASS = SysFunctionDto.class.getName();
  private static final String SWGS_DTO_CLASS = SysFunctionWithGroupStatusDto.class.getName();
  private static final String GP_DTO_CLASS = GroupPermissionMapping.class.getName();
  ...
  public Optional<SysFunctionDto> findByCode(String functionCode, String langCode) {
    String jpql = """
        ...
        """.formatted(DTO_CLASS, SysFunctionDto.jpqlProjection("f", "flan"));
  ...
  public List<SysFunctionWithGroupStatusDto> findAllWithGroupStatus(Long groupId, String langCode) {
    String jpql = """
        ...
        ORDER BY f.functionCode ASC
        """.formatted(SWGS_DTO_CLASS, SysFunctionWithGroupStatusDto.jpqlProjection("f", "flan", "r"));
  ...
  public List<GroupPermissionMapping> findGroupPermissionMappingsByClientId(Long clientId) {
    String jpql = String.format("""
        ...
        JOIN g.clients c
        WHERE c.id = :clientId
        """, GP_DTO_CLASS, GroupPermissionMapping.jpqlProjection("g", "f"));
